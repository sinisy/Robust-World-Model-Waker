...
class Task(control.Task):
  ...
  *If sensor noise is enabled in the MuJoCo model then this will be generated
  ...
  def __init__(self, random=None, eval_cases=None):
  ...
  def update_physics(self, physics, params=None):
    """Update the physics of the simulator given some parameters, and 
    the previous physics object. By default this returns the same 
    physics as previously."""
    return physics
